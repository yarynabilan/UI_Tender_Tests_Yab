...
class UploadFiles : BaseTest() {
    ...
    fun CreateFolderAndUploadFileToDelete() {
        ...
        Thread.sleep(3000)
        driver.findElement(fileUpload.uploadFileButton).click()
        Thread.sleep(3000)
        tendersPage.switchToNewWindowTest()
        Thread.sleep(3000)

        driver.findElement(fileUpload.enhancedUploadTab).click()
    ...
    fun transferralUploadMyFolder() {
        ...
        Thread.sleep(2000)
        tendersPage.switchToNewWindowTest()
        driver.findElement(fileUpload.transferralUploadTab).click()
