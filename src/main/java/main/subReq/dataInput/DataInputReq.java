...
public class DataInputReq extends SubmissionRequirements {
    ...
    public WebElement field2() {return driver.findElement(field2);
    }public WebElement field3() {return driver.findElement(field3);}
    public WebElement field4() {return driver.findElement(field4);}
    public WebElement field5() {return driver.findElement(field5);}
    public WebElement field6() {return driver.findElement(field6);}
    public WebElement guidingField1() {return driver.findElement(guidingField1);}
    public WebElement guidingField2() {return driver.findElement(guidingField2);}
    public WebElement guidingField3() {return driver.findElement(guidingField3);}
    public WebElement guidingField4() {return driver.findElement(guidingField4);}
    public WebElement guidingField5() {return driver.findElement(guidingField5);}
    public WebElement guidingField6() {return driver.findElement(guidingField6);}
    public WebElement guidingField7() {return driver.findElement(guidingField7);}
    public WebElement lastOkButton() {return driver.findElement(lastOkButton);}
    private WebElement addButton() {return driver.findElement(addButton);
    }
